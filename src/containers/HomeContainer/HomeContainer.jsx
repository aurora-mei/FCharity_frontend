...
const HomeContainer = () => {
  ...
  return (
    <div>
      {" "}
      {/* Bỏ Flex ở đây nếu không cần thiết cho toàn bộ */}
        ...
        <NotingGreen
          message={
            <>
              ...
              Connect with like-minded people, share opportunities, and support
              those in need.
            </>
          }
          bgColor="#F0FCE9"
          style={{ color: "black", padding: "3rem 0", textAlign: "center" }}
        />
        <Flex vertical={true} style={{ margin: "4rem 10rem" }}>
          <ForumBoard />
        </Flex>
        <NotingGreen
          message="FCharity – Connecting Hearts, Changing Lives"
          bgColor="#012D19"
          style={{
            color: "white",
            padding: "10rem 0",
