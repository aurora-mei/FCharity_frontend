...
const PostItem = ({ postResponse }) => {
  ...
  // Chỉ quản lý userVote state, voteCount lấy trực tiếp từ postResponse
  const [userVote, setUserVote] = useState(postResponse?.post.userVote || 0);
  const voteCount = postResponse?.post.vote || 0; // Sử dụng trực tiếp từ props
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <Space size={4}>
          ...
          />
          {/* Sử dụng trực tiếp voteCount từ postResponse */}
