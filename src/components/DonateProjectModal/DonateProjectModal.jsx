            ...
            >
                <Form
                    ...
                    onValuesChange={(changedValues, allValues) => {
                        console.log('Changed value:', changedValues); // Log giá trị thay đổi
                        console.log('All values:', allValues); // Log tất cả giá trị của form
                    }}
                ...
                >
                    ...
                    >
                        <InputNumber
                            ...
                            max={balance}
                            style={{ width: '100%' }}
                            value={form.getFieldValue('amount')} // Đảm bảo giá trị được bind với form
                    ...
                    <Form.Item>
                        <StyledButton type="primary" htmlType="submit" style={{ backgroundColor: "green", color: "white", border: "none" }}>
                            Donate
                        </StyledButton>
                    </Form.Item>
                </Form>
