    ...
    Modal.confirm({
      ...
      content: (
        <>
          ...
          <p>
            <strong>Amount:</strong> {values.amount.toLocaleString()} VND
          </p>
          {values.message && (
            <p>
      ...
      <Form form={form} layout="vertical" onFinish={showConfirm}>
          ...
          rules={[
            ...
            },
            {
              ...
              message:
                balance < 1000 ? (
                  <>
                    You don't have enough balance to donate. Please{" "}
                    <Link to="/user/manage-profile/mywallet">
                      make a deposit
                    </Link>{" "}
                    to continue
                  </>
        ...
        >
          ...
          <div style={{ marginTop: 8, fontSize: "0.8rem", color: "#8c8c8c" }}>
            * Minimum amount: {"1000".toLocaleString()} VND, Maximum amount:{" "}
        ...
        >
          <Input type="text" maxLength={50} placeholder="Enter message" />
        </Form.Item>
