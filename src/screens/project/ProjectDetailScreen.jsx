...
const columns = [
    {
        ...
        key: 'donationTime',
        render: (text) => (
            <Text style={{ fontSize: '0.7rem' }}>{moment(text).tz('Asia/Ho_Chi_Minh').format('DD/MM/YYYY hh:mm A')}</Text>
        ),
                    ...
                    <Flex gap={0} vertical className="request-detail-page" >
                        ...
                        <Flex vertical gap={0} className="request-detail">
                                ...
                                <Paragraph className="request-tags">
                                    {projectTags.map((taggable) => (
                                        <Badge key={taggable.tag.id}
                                            count={
                                                <span style={{ backgroundColor: "#DFF6E1", color: "#177A56", padding: "5px 10px", fontSize: "0.9rem", borderColor: "#2C9D63 !important", fontWeight: "bold", borderRadius: 20, display: "flex", alignItems: "center", gap: 5 }}>
                            ...
                            {expanded ? <Paragraph>
                                ...
                                Gurvinder was the most kind, soft-spoken, and respectful soul—always smiling and spreading positivity. He was not just my husband but my best friend and the most loving father to our 6-year-old son, Williamjeet Singh and he was the only child of his parents. Our world has been turned upside down in an instant, and I am struggling to come to terms with this heartbreaking loss.

                                As I now face life without him, I humbly ask for your support to help me provide stability for our son. This fundraiser will help cover funeral expenses, immediate living costs, and ensure Williamjeet’s future is secure during this difficult transition.

                                Your kindness, prayers, and generosity mean the world to us. No donation is too small, and if you’re unable to contribute, please share this fundraiser with others.

                                Thank you for your love and support in this devastating time.

                                With gratitude,
                                Maninder Kaur & Williamjeet Singh
                                {`${project.projectDescription} `} </Paragraph> : <Paragraph>{`${project.projectDescription.substring(0, 800)}...`}</Paragraph>}
                            ...
                            <StyledSection.Container>
                                <Title level={5} style={{ margin: 0 }} >Organization</Title>
                                <StyledSection.ProfileSection>
                                    ...
                                    <StyledSection.Info>
                                        ...
                                        <StyledSection.ContactButton>Contact</StyledSection.ContactButton>
                                    </StyledSection.Info>
                                </StyledSection.ProfileSection>
                                ...
                                <StyledSection.Meta>
                                    Created {moment().diff(moment(project.createdAt), 'days')} d ago · <a href="#">{project.categoryName}</a>
                                </StyledSection.Meta>
                    ...
                    <StyledWrapper>
                        <Card className="donation-card">
                            <Flex justify="space-between" align="center" style={{ marginBottom: 16 }}>
                                <Title level={5} style={{ margin: 0 }}>Donation Records</Title>
